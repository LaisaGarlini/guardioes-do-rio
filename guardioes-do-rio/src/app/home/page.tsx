    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen">
            ...
            <div className="mt-4">
                ...
                <div className="flex justify-center space-x-4 mt-4">
                    <button onClick={() => router.push('/cupom-consulta')} className="bg-green-300 hover:bg-green-400 w-32 h-32 rounded-3xl shadow-2xl shadow-slate-400 flex justify-center items-center flex-col transition duration-200">
